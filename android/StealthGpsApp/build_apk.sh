...
OUT_DIR="$ROOT/build/stealthgpsbuild"
APK_DIR="$ROOT/system/priv-app/StealthGps"
...
javac \
  ...
  -d "$OUT_DIR/classes" \
  "$ROOT/android/StealthGpsApp/src/main/java/com/stealthgps/GpsService.java" \
  "$ROOT/android/StealthGpsApp/src/main/java/com/stealthgps/BootReceiver.java"
...
cp "$ROOT/android/StealthGpsApp/src/main/AndroidManifest.xml" "$OUT_DIR/apk/AndroidManifest.xml"
cd "$OUT_DIR/apk"
...
"$BUILD_TOOLS/apksigner" sign \
  ...
  --out "$APK_DIR/StealthGps.apk" \
  "$OUT_DIR/unsigned.apk"

echo "Built APK: $APK_DIR/StealthGps.apk"
