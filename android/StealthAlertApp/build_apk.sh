...
OUT_DIR="$ROOT/build/stealthalertbuild"
APK_DIR="$ROOT/system/priv-app/StealthAlert"
...
javac \
  ...
  -d "$OUT_DIR/classes" \
  "$ROOT/android/StealthAlertApp/src/main/java/com/stealthalert/AlertActivity.java"
...
cp "$ROOT/android/StealthAlertApp/src/main/AndroidManifest.xml" "$OUT_DIR/apk/AndroidManifest.xml"
cd "$OUT_DIR/apk"
...
echo "Built APK: $APK_DIR/StealthAlert.apk"
