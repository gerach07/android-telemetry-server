...
OUT_DIR="$ROOT/build/stealthmonitorbuild"
APK_DIR="$ROOT/system/priv-app/StealthMonitor"
...
"$BUILD_TOOLS/apksigner" sign \
  ...
  --out "$APK_DIR/StealthMonitor.apk" \
  "$OUT_DIR/unsigned.apk"

echo "Built APK: $APK_DIR/StealthMonitor.apk"
